...
export default function MyPixelTab(props){
    return(
        <div className="myPixel-tab">
            ...
            <div className="myPixel-table-wrapper" style={{marginTop: '14px', paddingBottom: '34px',marginBottom: '34px', borderBottom: '1px solid #DFE3E8'}}>
                <PixelDataTable rows={pixelTabRows} headings={['Client Account', 'Status', 'Action']}></PixelDataTable>
            </div>
            <ActionItem />
        </div>
    )
